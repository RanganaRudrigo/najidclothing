...
$(document).ready(function()
{
	...
	$(document).on('click', '#layered_form input[type=button], #layered_form label.layered_color', function(e) {
		if (!$('input[name="'+$(this).attr('name')+"["+$(this).data('for')+"][]"+'"][type=hidden]').length)
			$('<input />').attr('type', 'hidden').attr('name', $(this).attr('name')+"["+$(this).data('for')+"][]").val($(this).attr('rel')).appendTo('#layered_form');
		else
			$('input[name="'+$(this).attr('name')+"["+$(this).data('for')+"][]"+'"][type=hidden]').remove();
		reloadContent(true);
	});
...
function reloadContent(params_plus)
{
	...
	{
		type: 'GET',
		url: baseDir + 'api/blocklayered/filter',
