...
<body id="order"  itemscope itemtype="" class="category category-54 category-cardigans hide-right-column lang_en
              ...
              <form action="" method="post" id="create-account_form" class="box">
                ...
                <div class="form_content clearfix">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="is_required validate account_input " data-validate="isEmail" id="email_create" name="email_create" size="45" value="" />
                  </div>
                  <div class="submit">
                    <input type="hidden" class="hidden" name="back" value="my-account" />
                    <button class="button button-medium exclusive" type="submit" id="SubmitCreate" name="SubmitCreate"> <span> <i class="fa fa-user left"></i> Create an account </span> </button>
              ...
              <form action="" method="post" id="login_form" class="box">
                ...
                <div class="form_content clearfix">
                  <div class="form-group">
                    ...
                    <input class="is_required validate account_input " size="45" data-validate="isEmail" type="text" id="email" name="email" value="" />
                  </div>
                  <div class="form-group">
                    <label for="passwd">Password</label>
                    <input class="is_required validate account_input "  size="45" type="password" data-validate="isPasswd" id="passwd" name="passwd" value="" />
                  </div>
                  <p class="lost_password form-group"><a href="http://prestashop.magentech.com/sp_lovefashion/sp_lovefashion4/en/password-recovery" title="Recover your forgotten password" rel="nofollow">Forgot your password?</a></p>
                  <p class="submit">
                    <input type="hidden" class="hidden" name="back" value="my-account" />
                    <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button"> <span> <i class="fa fa-lock left"></i> Sign in </span> </button>
                  </p>
                </div>
              </form>
            </div>
