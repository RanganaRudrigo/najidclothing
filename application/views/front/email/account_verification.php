                    ...
                    <tr>
                        <td align="center" style="padding:7px 0">
                            <font size="2" face="Open-sans, sans-serif" color="#555454">
                                ...
                                <span style="font-weight:500;font-size:16px;text-transform:uppercase;line-height:25px">Your Account Has Been Created Successfully</span>
                            </font>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table style="width:100%">
                                <tbody><tr>
                                    ...
                                    <td style="padding:7px 0">
                                        <font size="2" face="Open-sans, sans-serif" color="#555454">
                                            <a style="margin:3px 0 7px;text-transform:uppercase;font-weight:500;font-size:18px;padding-bottom:10px"
                                            href="<?=base_url("user/verify?token=$customer->token")?>"
                                            >
