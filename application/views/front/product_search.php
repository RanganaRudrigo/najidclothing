        ...
        <div class="container">
            <div class="row">
                ...
                <div class="breadcrumb ">
                    ...
                    <span class="navigation-pipe">></span> Search
                </div>
                <!-- /Breadcrumb -->
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div id="center_column" class="center_column col-sm-8 col-md-9 ">
                    ...
                    <div class="content_scene_cat ">
                        ...
                        <div class="content_scene_cat_bg" style="background:url() right center no-repeat; background-size:cover; min-height:217px;">
                            <div class="content_scene">
                                <div class="col-lg-5" >
                                    <h1 class="category-name  ">
                                        <?= ucfirst($school->title) ?> </h1><br/>
                                    <img src="<?= UP.$school->image ?>" >
                                </div>
                    ...
                    <!-- Products list -->
                    <?php   $this->view('front/inc/product_list_ul',array('products'=>$products , 'link' => base_url("school/". url_title($school->title)."/".$school->id."/". url_title($grade->title)."/".$grade->id)."/") ); ?>
                    <div class="content_sortPagiBar clearfix">
                        <div class="sortPagiBar  clearfix">
                            <div class="row">
                                <div class="col-xs-12">
